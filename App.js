   ...
   <Stack.Screen
    ...
    />
     <Stack.Screen
      ...
      name="payment"
      component={payment} options={{title:"Booking",headerTintColor:"#fff",headerTitleAlign:'center', headerRight: () => (
          <MaterialCommunityIcons
            name="bell"
            size={23}
            color="#fff"
      ...
      name="Bookingmember"
      component={Bookingmember} options={{title:"Booking",headerTintColor:"#fff",headerTitleAlign:'center', headerRight: () => (
          <MaterialCommunityIcons
            name="bell"
            size={23}
            color="#fff"
      ...
      name="sheets"
      component={sheet} options={{title:"Booking",headerTintColor:"#fff",headerTitleAlign:'center', headerRight: () => (
          <MaterialCommunityIcons
            name="bell"
            size={23}
            color="#fff"
